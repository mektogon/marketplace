...
class CategoryControllerTest extends BaseApiTest {
    ...
    void getCategories_shouldReturnSuccessAndNotEmptyResponse() {
        ...
        List<WebCategory> categories = webCategoryResponse.getCategories();
    ...
    void getCategories_shouldReturnBadRequestAndErrorResponse() {
        Response response = makeRequest(
                ...
                HttpMethod.POST,
                null,
                getWebCategoryRequest(null, null)
        );
     ...
     */
    public static WebCategoryRequest getWebCategoryRequest(Integer pageIndex, Integer pageSize) {
